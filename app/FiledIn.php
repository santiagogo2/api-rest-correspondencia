...
class FiledIn extends Model
{
    ...
    protected $fillable = [
        'app_users_id', 'dependence_id', 'documents_id',
        'document_date', 'affair', 'number_folios',
        'attached_id', 'refrence', 'guide'
    ];
}
